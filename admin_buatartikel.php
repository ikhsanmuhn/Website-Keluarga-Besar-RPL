...
<head>
    ...
    <title>Admin Keluarga Besar RPL | Buat Artikel</title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">BUAT ARTIKEL</h4>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="d-flex flex-column col-lg-5 col-xlg-6 col-md-12">
                        <div class="d-flex justify-content-start">
                            <span class="d-flex judul_profil font-bold" style="line-height:80px; width: 300px;height: 250px;font-family: Montserrat;font-style: normal;font-weight: bold;font-size: 60px;color: #3b3838;text-align: left; margin-left:100px;">Buat Artikel Jurusan</span>
                        </div>
                        <div class="d-flex justify-content-start">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card" style="margin-top:50px;">
                            <div class="card-body"  >
                                <form class="form-horizontal form-material" method="POST" action="a_admin_buatartikel.php" autocomplete="off" enctype="multipart/form-data">
                                    <div class="form-row">
