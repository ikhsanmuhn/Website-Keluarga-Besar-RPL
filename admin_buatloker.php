...
<head>
    ...
    <title>Admin Keluarga Besar RPL | Buat Lowongan Pekerjaan</title>
...
<?php
    ...
    $id_lokerauto= $_SESSION['id_value'];
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">BUAT LOWONGAN PEKERJAAN</h4>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="row">
                     ...
                     <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="card" style="margin: 0; height: 370px;">
                            <div class="card-body">
                                <img src="img/default_image.jpg" style="width: 270.75px; height:318px" id="gambar_tampil">
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="d-flex flex-column col-lg-8 col-xlg-9 col-md-12">
                        <div class="d-flex justify-content-start">
                            <span class="d-flex judul_profil font-bold" style="line-height:80px; width: 500px;height: 150px;font-family: Montserrat;font-style: normal;font-weight: bold;font-size: 65px;color: #3b3838;text-align: left;  margin-bottom: 50px; margin-left:100px;">Buat Lowongan Pekerjaan</span>
                        </div>
                        <div class="d-flex justify-content-start">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card" style="margin-top:50px;">
                            <div class="card-body"  >
                            <form class="contact100-form validate-form" method="POST" action="a_tampil_loker.php" autocomplete="off" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputAddress">Id Loker</label>
                                            <input type="text" class="form-control" id="inputAddress" placeholder="L001" disabled="disabled" value="<?php echo $id_lokerauto?>">
                                            <input type="hidden" name="id_loker" value="<?php echo $id_lokerauto;?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" name="btn_buatloker" style="width: 198.39px; height: 38.4px; background-color: #FFA62B; border-radius: 20px; ">Buat Lowongan Kerja</button>
                                        </div>
                                    </div>    
                                </form>
                            </div>
