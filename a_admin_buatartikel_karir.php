     ...
     if (isset($_POST['btn_buatartikel'])){
         try{
             ...
             {   
                 ...
                 $sql="INSERT INTO karir (id_karir,nik, prolog,judul_artikel, deskripsi, tanggal, image, image_type) VALUES('" .$id_karir. "','" .$nik. "', '" .$prolog. "', '" .$judul_artikel. "','" .$deskripsi. "','" .$tanggal. "','" .$image. "','" .$image_properties['mime']. "','" .$verifikasi. "')";
