...
<?php
    ...
    $sql="SELECT id_info FROM info_jurusan ORDER BY id_info DESC LIMIT 1";
    $stmt = $db->prepare($sql);
    $stmt->execute();
    ...
    if(empty($row)){
        ...
        $angka=preg_replace('/[^0-9]/','',$row['id_info']);
        $angka++;
    }

    $formatted_value = "AI".sprintf("%03d", $angka);
    $_SESSION['id_value'] = $formatted_value;
    $id_infoauto = $_SESSION['id_value'];
?>
<body>
                ...
                <div class="row">
                    ...
                    <div class="d-flex flex-column col-lg-6 col-xlg-6 col-md-12">
                        <div class="d-flex justify-content-start">
                            <span class="d-flex judul_profil font-bold" style="line-height:80px; width: 500px;height: 150px;font-family: Montserrat;font-style: normal;font-weight: bold;font-size: 65px;color: #3b3838;text-align: left;  margin-bottom: 50px; margin-left:100px;">Buat Artikel Info</span>
                        </div>
                        <div class="d-flex justify-content-start">
                            <span class="penjelasan_loker" style="width:550px; margin-left:100px;">Akang dan teteh dapat turut bnerkontribusi dalam mentampaikan konten di dalam website keluarga besar RPL denngan mengirimkan artikel yang akang dan teteh buat, tentunya artikel yang dikirimkan artikel yang berhubungan dengan informasi jurusan, seputar RPL atau yang lainnya.</span>                        
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card"  style="margin-top:50px;">
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="a_buatartikel.php" autocomplete="off" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputAddress">Id Info</label>
                                            <input type="text" disabled="disabled" class="form-control"  value="<?php echo $id_infoauto;?>">
                                            <input type="hidden" name="id_info" value="<?php echo $id_infoauto;?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select id="inputKategori" class="form-control" name="id_kategori" style="background: transparent;">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4" >
                                            <label for="inputAddress">Orientasi Gambar</label>
                                            <select id="inputKategori" onchange=""class="form-control" name="orientasi" style="background: transparent;">
                                                <option selected value=""></option>
                                    ...
                                    <input type="hidden""  value="0" name="verifikasi">
