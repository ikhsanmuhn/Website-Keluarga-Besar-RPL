     ...
     if (isset($_POST['btn_buatartikel'])){
        try{
            ...
            {   
                ...
                $sql="INSERT INTO info_jurusan (id_info,nik, id_kategori, judul, prolog,deskripsi, tanggal, image, image_type, orientasi,verifikasi) VALUES('" .$id_info. "','" .$nik. "','" .$id_kategori. "', '" .$judul. "','" .$prolog. "','" .$deskripsi. "','" .$tanggal. "','" .$image. "','" .$image_properties['mime']. "','" .$orientasi. "','" .$verifikasi. "')";
