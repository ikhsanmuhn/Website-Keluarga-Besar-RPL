...
<head>
    ...
    <title>Admin Keluarga Besar RPL | Tambah User</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="user-bg"> 
                            <img alt="user" src="img/default_image.jpg" style="border-radius: 25px;" id="gambar_tampil">
                        </div>
                    </div>
                    <!-- Column -->
                    <!-- Column -->
                    <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                            <form class="form-horizontal form-material" method="POST" action="a_admin_tambahuser.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="password" placeholder="Masukan Email"
                                            class="form-control p-0 border-0" name="pw">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <textarea rows="4" class="form-control p-0 border-0" name="alamat"></textarea>
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="date"
                                            class="form-control p-0 border-0" name="tgl_lahir">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success" name="btn_tambahuser" style="width: 198.39px; height: 38.4px; background-color: #FFA62B; border-radius: 20px; ">Tambah User</button>
                                    </div>
                                </div>
                            </form>
                            </div>
